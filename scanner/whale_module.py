...
تلقائياً كل WHALE_SCAN_INTERVAL_SECONDS (ساعة افتراضياً، ساعات السوق فقط
-- bot.py's job_queue.run_repeating، بنفس نمط _position_monitor_job)، أو
فورياً بأمر /whales اليدوي (أي عضو مؤهل يشغّله، لكن نتائجه تُبث لكل
الأعضاء المعتمدين حالياً، وليس فقط لمن كتب الأمر) -- انظر bot.py's
_run_whale_scan المشتركة بين المسارين.
"""
import asyncio
