...
def alerts_text():
    ...
    return "\n".join([
        ...
        "▸ سجّل صفقاتك هنا",
        "",
        "اكتب زي ما تتكلم — بلا أوامر ولا صيغة:",
        "",
        "  اشتريت سترايك 186",
        "  خرجت 2.59",
        "",
        "ما تحتاج ترد على الرسالة ولا تكتب اسم السهم.",
        "",
        "▸ بعد ما تشتري، أراقبه كل دقيقة",
        "",
        "ما أرسل تقارير. أرسل فقط لو صار شيء:",
        "  🔴 السهم رجع تحت المستوى — الفكرة انتهت",
        "  🔴 وصل الهدف، أو قرب الإغلاق",
        "  🟡 الشراء خفّ، أو يبيعون هذا السترايك",
        "  🟢 تجاوز +20% أو +40% لأول مرة",
        "",
        "الصمت معناه: ماشية، ما فيه جديد.",
        "",
        "وتقدر تسألني في أي وقت: «ابيع سترايك 186؟»",
        "",
        "⚠️ ما أرى المستقبل. أقرأ من يشتري ومن يبيع الآن،",
        "والبيانات دقيقة بالدقيقة لا بالثانية.",
        "",
        "ونهاية اليوم يوصلك ملخّص صفقاتك أنت.",
        "",
        "▸ ما لا يفعله",
        "",
